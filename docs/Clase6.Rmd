...
- duck: abundancia de New Zealand duck mussel o *Anadara novaezelandiae*
...
Elaborar una tabla de selección de modelos para identificar el modelo o los modelos más adecuados para explicar la abundancia del mejillón de agua dulce de Nueva Zelanda (*Anadara novaezelandiae*). Realizar la validación y graficado del modelo.
