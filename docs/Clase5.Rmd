...
Esta base de datos proviene de la investigación de doctorado del Dr. McGarigal en el noroeste del Pacífico de EEUU [paper](https://doi.org/10.2307/2937059).
...
plot_model(fit3, "pre", terms = c("saw","stream.den"),
           show.data = TRUE,
           grid = TRUE)
```
